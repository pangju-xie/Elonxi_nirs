...
void app_read_emg_sd_data_to_app_multi(uint32_t packcnt);
...
/****************************************************************************************
  * Function:	  
  * 		 app_read_emg_sd_data_to_app_multi
  * Description: 
  * 		 read sd data to app for wifi
  * Parameters:  
  * 		 [void]
...
void app_read_emg_sd_data_to_app_multi(uint32_t packcnt)
{
    ...
    else
    {
        ...
        udpUpAppSendData(g_app_var.emg_sd_read_buffer, len);
    }
}
...
/****************************************************************************************
  ...
  * 		 void
*****************************************************************************************/
void app_read_nirs_sd_data_to_app_multi(uint32_t packcnt)
{
    static uint8_t led_set_first = 1;
    int ret = 0; 
...
/****************************************************************************************
  * Function:	  
  * 		 app_read_sd_data_to_app_imu_multi
  * Description: 
  * 		 read sd data to app for wifi
  * Parameters:  
  * 		 [void]
...
void app_set_emg_dr(void)
{
    ...
    switch(g_app_var.rf_emg_dr_index){
        ...
        case 1:g_app_var.emg_dr_pack = SAMPLE_RATE_EMG_2K;break;
        case 2:g_app_var.emg_dr_pack = SAMPLE_RATE_EMG_4K;break;
        default:g_app_var.emg_dr_pack = SAMPLE_RATE_EMG_1K;break;
    }
    ESP_LOGI(TAG, "set nirs sample rate index: %d", (int)g_app_var.rf_emg_dr_index);
    send_cmd_to_stm32(0x01, g_app_var.rf_emg_dr_index);
...
void app_set_nirs_dr(void)
{
    ...
    switch(g_app_var.rf_nirs_dr_index){
        ...
        case 1:g_app_var.nirs_dr_pack = SAMPLE_RATE_NIRS_50;break;
        case 2:g_app_var.nirs_dr_pack = SAMPLE_RATE_NIRS_20;break;
        case 3:g_app_var.nirs_dr_pack = SAMPLE_RATE_NIRS_10;break;
        default:g_app_var.nirs_dr_pack = SAMPLE_RATE_NIRS_50;break;
    }
    ESP_LOGI(TAG, "set nirs sample rate index: %d", (int)g_app_var.rf_nirs_dr_index);
    send_cmd_to_stm32(0x02, g_app_var.rf_nirs_dr_index);
    // vTaskDelay(2000 / portTICK_PERIOD_MS);
    led_set('B', PIN_RESET);
    // esp_restart();
}
...
{
    pvParameters = pvParameters;
    g_app_var.payload = malloc(UART_RX_BUF_SIZE);
